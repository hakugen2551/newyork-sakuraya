...
| GitHub アカウント | 名前 | 役割 |
|---|---|---|
| `hakugen2551` | お店オーナー本人 | 日常更新(写真差し替え、メニュー追加、お知らせ等) |
| `kuliaxwz` | 白源(担当者) | レイアウト変更・新機能・トラブル対応 |

両者ともプログラミング知識は限定的。**専門用語は避け、日本語で丁寧に確認しながら進めること。**
...
│                                                                        │
│    [ お店オーナー PC ]                  [ 担当者 PC ]                   │
│       hakugen2551                          kuliaxwz                    │
│           │                                    │                       │
│           │  Claude Code 起動                  │  Claude Code 起動      │
│           │  → 自動で git pull                  │  → 自動で git pull     │
│           │  → 編集                            │  → 編集                │
│           │  → 「pushして」                     │  → 「pushして」        │
│           └────────────┬───────────────────────┘                       │
│                        │ git push                                      │
